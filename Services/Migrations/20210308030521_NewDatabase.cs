    ...
    public partial class NewDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountHolders", x => new { x.UserName, x.Password });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Employees", x => new { x.UserName, x.Password });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountHolderPassword = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AccountHolderUserName = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Transactions", x => x.TransactionID);
                    table.ForeignKey(
                        name: "FK_Transactions_AccountHolders_AccountHolderUserName_AccountHolderPassword",
                        columns: x => new { x.AccountHolderUserName, x.AccountHolderPassword },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_AccountHolderUserName_AccountHolderPassword",
                table: "Transactions",
                columns: new[] { "AccountHolderUserName", "AccountHolderPassword" });
        }
